...
This app is a pure student project and is not used for commercial purposes only private uses. The application's program code is copyrighted. The App's Data is from the open and free openmensa.org API
